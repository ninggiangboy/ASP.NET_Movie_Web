        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtherTitle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    AverageRating = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    TotalEpisode = table.Column<int>(type: "int", nullable: true),
                    DurationPerEpisode = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Episodes_Films_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Films",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavoriteFilmsId = table.Column<int>(type: "int", nullable: false),
                    FollowersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmUser", x => new { x.FavoriteFilmsId, x.FollowersId });
                    table.ForeignKey(
                        name: "FK_FilmUser_AspNetUsers_FollowersId",
